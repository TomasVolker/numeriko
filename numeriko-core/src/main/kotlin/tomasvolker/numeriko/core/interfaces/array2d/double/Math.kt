 ...
 */
operator fun DoubleArray2D.unaryPlus(): DoubleArray2D = this

/**
 * Returns a copy of this array with element wise negation.
 */
operator fun DoubleArray2D.unaryMinus(): DoubleArray2D = elementWise { -it }
 ...
 * Returns an array with the element wise addition with [other].
 */
operator fun DoubleArray2D.plus(other: Double): DoubleArray2D = elementWise { it + other }

/**
 * Returns an array with the element wise subtraction with [other].
 */
operator fun DoubleArray2D.minus(other: Double): DoubleArray2D = elementWise { it - other }

/**
 * Returns an array with the element wise multiplication with [other].
 */
operator fun DoubleArray2D.times(other: Double): DoubleArray2D = elementWise { it * other }

/**
 * Returns an array with the element wise division with [other].
 */
operator fun DoubleArray2D.div(other: Double): DoubleArray2D = elementWise { it / other }

/**
 * Returns an array with the element wise reversed division with [other].
 */
fun DoubleArray2D.rdiv(other: Double): DoubleArray2D = elementWise { other / it }

/**
 * Returns an array with the element wise addition with [other].
 */
operator fun DoubleArray2D.plus(other: Int): DoubleArray2D = plus(other.toDouble())

/**
 * Returns an array with the element wise subtraction with [other].
 */
operator fun DoubleArray2D.minus(other: Int): DoubleArray2D = minus(other.toDouble())

/**
 * Returns an array with the element wise multiplication with [other].
 */
operator fun DoubleArray2D.times(other: Int): DoubleArray2D = times(other.toDouble())

/**
 * Returns an array with the element wise division with [other].
 */
operator fun DoubleArray2D.div(other: Int): DoubleArray2D = div(other.toDouble())

/**
 * Returns an array with the element wise reversed division with [other].
 */
fun DoubleArray2D.rdiv(other: Int): DoubleArray2D = elementWise { other / it }
