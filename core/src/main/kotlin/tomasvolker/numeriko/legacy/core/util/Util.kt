package tomasvolker.numeriko.legacy.core.util
...
import tomasvolker.numeriko.legacy.core.interfaces.integer.arraynd.get
...
internal fun indexArrayToLinearIndex(shapeArray: IntArray, indexArray: ReadOnlyIntArrayND): Int {
    ...
    return indexArrayToLinearIndex(
            shapeArray,
            { dimension -> indexArray.getInt(dimension) }
    )
}
