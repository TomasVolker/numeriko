...
interface Array2D<out T>: ArrayND<T> {
    ...
    fun getValue(i0: Int, i1: Index): T = getValue(i0, i1.computeValue(shape1))
    fun getValue(i0: Index, i1: Int): T = getValue(i0.computeValue(shape0), i1)
    fun getValue(i0: Index, i1: Index): T = getValue(i0.computeValue(shape0), i1.computeValue(shape1))
    ...
    fun getView(i0: Index, i1: IntProgression): Array1D<T> =
            getView(i0.computeValue(shape0), i1)

    fun getView(i0: Index, i1: IndexProgression): Array1D<T> =
    ...
    fun getView(i0: IntProgression, i1: IndexProgression): Array2D<T> =
            getView(i0, i1.computeProgression(shape1))
    ...
    fun getView(i0: IndexProgression, i1: IntProgression): Array2D<T> =
            getView(i0.computeProgression(shape0), i1)
