...
import tomasvolker.simboliko.function1.DifferentiableExpressionFunction1
...
import tomasvolker.simboliko.function2.DifferentiableExpressionFunction2
...
interface Expression {
    ...
    operator fun plus(other: Expression) =
            simplifyPlus(other) ?: Addition(this, other)

    operator fun minus(other: Expression) =
            simplifyMinus(other) ?: Subtraction(this, other)

    operator fun times(other: Expression) =
            simplifyTimes(other) ?: Multiplication(this, other)

    operator fun div(other: Expression) =
            simplifyDiv(other) ?: Division(this, other)
